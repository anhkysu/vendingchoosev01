...
class ProcessMomoTransaction extends Component {
    ...
    testFunction() {
        this.sendSerialData(JSON.stringify({topic:"momoMethod", type:"response", content: {status: "ok"}}), true);
    ...
    showUiMomoTransactionTimeout(a, b){
        this.showUiNotification("Thông báo", "Xin lỗi! Đã quá thời gian quét Momo...Mời bạn thử lại!");
    }
    //#endregion
    ...
    startQrScanningTimeout(millis) {
        ...
        this.qrscanningtimeout = setTimeout(() => { this.onAppTimeoutTransaction() }, waitin)
    }
            ...
            <View style={{ display: "flex", flex: 1 }}>
                ...
                <View style={{ height: 50, width: "100%", backgroundColor: "lightblue", alignItems: "center", justifyContent: "center", display: "flex", flexDirection: "row" }}>
                    ...
                    <View style={{ width: 150, height: "100%", backgroundColor: "lightblue", display: "flex", alignItems: "flex-end", justifyContent: "center", paddingRight: 10 }}>
                        ...
                        <TouchableOpacity onPress={() => { this.onCancelTransaction() }} style={{ backgroundColor: "dodgerblue", borderRadius: 5, padding: 7, paddingVertical: 10, justifyContent: "center" }}>
                            <Text style={{ fontSize: Number(this.props.settingdatalist[9].datainput), color: "white" }}>HỦY GIAO DỊCH</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
